    ...
    <form action="{{ route('stock.update',$stock->id) }}" enctype="multipart/form-data" method="post">
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="form-group row d-flex" style="margin-left: -15px; margin-right: -15px;">
                    ...
                    <div class="col-1 add-detail-btn-wrapper" style="width: 100%; height: auto;">
                        <button class="btn btn-primary rounded-circle w-100" id="addDetail"><i class="fa fa-plus"></i> </button>
                    </div>

                </div>

                <div class="row d-flex mt-3">
                    <div class="col-4 text-center font-weight-bold">Room No</div>
                    <div class="col-4 text-center font-weight-bold">Rack No</div>
                    <div class="col-4 text-center font-weight-bold">Qty</div>
                </div>
                ...
                @else
                    <div class="col-12 d-flex stock-detail">
                        ...
                        <div class="form-group row">
                            <button class="btn btn-danger rounded-circle" id="removeDetail" style="height: 26px;
                        position: absolute;
                        margin-left: 25px;
                        margin-top: 43px;
                        width: 27px;"><i class="fa fa-times"></i></button>
